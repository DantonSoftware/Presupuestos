...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class ServicioReportes : IServicioReportes
    {
        ...
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerateFechaInicioYFin(mes, año);
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GenerateFechaInicioYFin(int mes, int año)
        {
