...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        public async Task<IActionResult> Semanal(int mes, int año)
        {
            ...
            var fechaRefencia = new DateTime(año, mes, 1);
            var diasDelMes = Enumerable.Range(1, fechaRefencia.AddMonths(1).AddDays(-1).Day);
            ...
            modelo.FechaReferencia = fechaRefencia;
        ...
        [HttpGet]
        public async Task<FileResult> ExportarPorAño(int año)
        {
